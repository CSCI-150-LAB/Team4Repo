...
<div class=mapHolder>
    <div class="mapTitle">
            <a href="https://www.fresnostate.edu/map/" target="_blank">Fresno State Campus Map</a>
    </div>
    <img src="./images/CampusMap.jpg" alt="Fresno State Campus Map">

    <div class=mapText>
        <h2> Recommended Meet Up Locations: </h2>
    </div>
